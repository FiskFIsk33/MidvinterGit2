						...
						<header class="entry-header">
							...
							<div class="entry-meta">
								<?php
									...
									printf( __( '<span class="meta-prep meta-prep-entry-date updated">Published </span> <span class="entry-date updated"><abbr class="published" title="%1$s">%2$s</abbr></span> at <a href="%3$s" title="Link to full-size image">%4$s &times; %5$s</a> in <a href="%6$s" title="Return to %7$s" rel="gallery">%8$s</a>', 'twentyeleven' ),
