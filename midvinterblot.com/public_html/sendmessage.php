...
//$title = "testing";
//$usermail = "hej@lal.woop";
//$content = "teestingwoop";

/*$title = "ännu ett test";
$usermail = "testosteronmannen@live.com";
$content = "nittonhundranittiosextusen dvärgar dricker latte snart";*/

$msg = "<h3 style='border-bottom:1px dotted #ccc'>Message via Midvinterblot.com</h2>\r\n";
$msg .= "<p>".$content."</p>\r\n";
...
$mail->Subject = "Contactbox Message: " . strip_tags($title);
$mail->Body    = $msg;
